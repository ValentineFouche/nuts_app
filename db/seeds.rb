...
Restaurant.create(title: "Di Piu", address: "87 quai des États-Unis, Nice, Alpes-Maritimes 06300, France", friend: "Ingo", comment: "Menu tres varie, il faut essayer", latitude: 43.6951577, longitude: 7.2727178, searched: false, viewed: false, user_id: valentine.id)
Restaurant.create(title: "La Voglia", address: "2 rue Saint-François de Paule, Nice, Alpes-Maritimes 06300, France", friend: "Alex", comment: "Tres bonne cuisine, il ne faut pas rater", latitude: 43.6956094, longitude: 7.2733957, searched: false, viewed: false, user_id: valentine.id)
Restaurant.create(title: "Lou Pistou", address: "4 Rue Raoul Bosio, Nice, Alpes-Maritimes 06300, France", friend: "Eva", comment: "Prix eleves mais le menu merite", latitude: 43.6965503, longitude: 7.273115, searched: false, viewed: false, user_id: valentine.id)
